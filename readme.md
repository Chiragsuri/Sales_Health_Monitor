...
│   ├── import\_core\_data.sql

│   ├── import\_ml\_baselines.sql

│   ├── create\_foundation\_kpi\_views.sql

│   ├── create\_monitoring\_procedures.sql

│   ├── validate\_eda\_insights.sql
...
│   ├── 02\_Data\_Cleaning\_Validation.ipynb

│   ├── 03\_EDA\_Analysis.ipynb

│   ├── 04\_EDA\_Advanced\_Analysis.ipynb

│   ├── 05\_ML\_Anomaly\_Detection.ipynb

│   ├── 06\_AI\_Text\_Insights.ipynb

│   └── 07\_Automation\_Alerts.ipynb
